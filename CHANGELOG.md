...
- **Project Decisions log** — บันทึก architectural decisions แบบ append-only พร้อม
...
- **Intent-driven steps** — RED/GREEN/REFACTOR ใน `/zie-build` เป็น paragraph สั้น
  แทน bullet micro-steps; config reads collapsed เป็น 1 บรรทัด
- **Version bump suggestion** — `/zie-ship` วิเคราะห์ Now lane + git log แล้ว suggest
