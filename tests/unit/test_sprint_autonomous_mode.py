...
class TestSprintAutonomousMode:
    def test_autonomous_mode_context_variable(self):
        assert "autonomous_mode" in text(), "sprint.md must set autonomous_mode context variable"
    ...
    def test_phase1_calls_autonomous_spec_design(self):
        ...
        assert "autonomous" in phase1.lower(), "Phase 1 must call spec-design with autonomous mode"
    ...
    def test_phase1_no_intermediate_agent_spawn(self):
        ...
        phase2_idx = t.index("PHASE 2")
        phase1 = t[phase1_idx:phase2_idx]
        assert 'subagent_type="general-purpose"' not in phase1 and "subagent_type='general-purpose'" not in phase1, (
    ...
    def test_interruption_protocol_documented(self):
        t = text().lower()
        assert "interrupt" in t or "interruption" in t, "sprint.md must document when to interrupt user"
