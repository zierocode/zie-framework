...
class TestVerifyCheck2TestOutputGuard:
    ...
    def test_check1_has_test_output_guard(self):
        ...
        assert "test_output" in check1_section, (
            "verify SKILL.md check 1 must mention test_output guard"
        )
    ...
    def test_check2_has_test_output_guard(self):
        ...
        assert "test_output" in check2_section, (
            "verify SKILL.md check 2 must guard against re-running make test-unit "
            "when test_output is already provided"
        )
