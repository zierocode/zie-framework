...
# /zie-hotfix — Emergency Hotfix Track
...
5. **Ship** — run `/zie-release` to merge and tag. If this is a patch fix,
...
- Use only for genuine emergencies. Routine bugs → `/zie-fix` inside the pipeline.
