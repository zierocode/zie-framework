...
- [ ] subagent-cache-adopt — [backlog](backlog/subagent-cache-adopt.md)
- [ ] intent-sdlc-lean — [backlog](backlog/intent-sdlc-lean.md)
- [ ] compact-output-lean — [backlog](backlog/compact-output-lean.md)
- [ ] pending-learn-dedup — [backlog](backlog/pending-learn-dedup.md)
- [ ] derive-stage-dedup — [backlog](backlog/derive-stage-dedup.md)
...
- [ ] roadmap-now-singleton — [backlog](backlog/roadmap-now-singleton.md)
